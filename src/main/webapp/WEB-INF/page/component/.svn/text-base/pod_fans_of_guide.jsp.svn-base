...
<div class="pod">
	<h2>关注该指南的人<span class="pcount f_brackets">(${page.totalCount})</span></h2>
	<ul id="fansList"  class="clean">
		<c:if test="${page.totalCount == 0}">
			<li class="cchrome1"><span class="lh150">还没有人关注该指南</span></li>
		</c:if>
		...
		<c:if test="${page.totalPage > 1}">
			<li class="mr8 mb8 h32 bcchrome2 bs1 br3 fl disI pr"><a id="apl_more" class="img-more lh32 br3" target="_blank" 
				href='<c:url value="/guide.follower.bc?id=${id}"/> '>更多</a></li>
		</c:if>
	</ul>
