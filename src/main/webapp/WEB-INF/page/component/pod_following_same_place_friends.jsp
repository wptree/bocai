...
<div class="pod">
	<h2>关注该店的好友<span class="pcount f_brackets">(<s:property value="bokePager.totalCount"/>)</span></h2>
	<ul id="fansList"  class="clean">
		<s:if test="bokePager.totalCount == 0">
			<li class="cchrome1"><span class="lh150">没有好友关注该店</span></li>
		</s:if>
		<s:iterator value="bokePager.list" var="user">
			<li class="mr8 mb8 w32 h32 bcw bs1 br3 fl"><a class="br3" target="_blank" href="${pageContext.request.contextPath}/user/profile.bc?id=<s:property value="id" />">
		...
		<s:if test="bokePager.totalPage > 1">
			<li class="mr8 mb8 w32 h32 bcchrome2 bs1 br3 fl disI pr"><a id="apl_more" class="img-more lh32 br3" target="_blank" 
