...
public class MagickImageScale {
	...
	public static void resizeFix(File srcFile, File destFile, int boxWidth,
			int boxHeight,double degree) throws IOException, MagickException {
		...
		//旋转
		if(degree != 0){
			scaled = image.rotateImage(degree);
		}
		// 输出
	...
	public static void resizeFix(File srcFile, File destFile, int boxWidth,
		...
		MagickImage image = new MagickImage(info);
		// 剪切
		Rectangle rect = new Rectangle(cutLeft,cutTop, cutWidth, catHeight);
		// 计算压缩宽高
	...
	public static void main(String[] args) throws Exception {
		...
		MagickImageScale.resizeFix(
				new File("C:\\Users\\wpeng\\Desktop\\web\\creatures.png"), new File(
						"C:\\Users\\wpeng\\Desktop\\web\\creatures2.png"), 600,300,270);
