...
/**
 * Created by IntelliJ IDEA. User:chenYuan (mail:cayurain@21cn.com) Date:
 * 2004-3-31 Time: 18:03:15 日期处理单元 com.jspx.utils.DateUtil
 */
public class DateUtil {
	...
	final static public String LABEL_CN_FORMAT = "MM月dd日,yyyy年";
	...
	final static public String SHORT_FORMAT = "MM月dd日";
	final static public String SHORT_DATE_TIME_FORMAT = "MM月dd日 HH:mm";
	...
	public static String getDateTimeShortStr(Date date){
		SimpleDateFormat dateFormat = new SimpleDateFormat(SHORT_DATE_TIME_FORMAT,
				Locale.CHINA);
		return dateFormat.format(date);
	}
